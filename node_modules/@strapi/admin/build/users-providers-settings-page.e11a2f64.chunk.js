"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[2282],{51509:(V,U,t)=>{t.r(U),t.d(U,{ProvidersPage:()=>be,default:()=>nt});var e=t(32735),P=t(5636),l=t(88425),L=t(23973),h=t.n(L),R=t(23940),D=t.n(R),f=t(10504),C=t(96709),x=t(28356),F=t(17e3),I=t(27649),d=t(94638),v=t(56755),c=t(33827),y=t(94547),b=t(19786),X=t(35658),K=t(88860),m=t(3685),O=t(50563),T=t(68625),M=t(84968),r=t(5173),s=t(59677);const u={id:(0,s.OB)("PopUpForm.Providers.redirectURL.front-end.label"),defaultMessage:"The redirect URL to your front-end app"},p={id:"http://www.client-app.com",defaultMessage:"http://www.client-app.com"},A={id:(0,s.OB)("PopUpForm.Providers.enabled.description"),defaultMessage:"If disabled, users won't be able to use this provider."},W={id:(0,s.OB)("PopUpForm.Providers.enabled.label"),defaultMessage:"Enable"},z={id:(0,s.OB)("PopUpForm.Providers.key.label"),defaultMessage:"Client ID"},k={id:(0,s.OB)("PopUpForm.Providers.redirectURL.label"),defaultMessage:"The redirect URL to add in your {provider} application configurations"},Q={id:(0,s.OB)("PopUpForm.Providers.key.placeholder"),defaultMessage:"TEXT"},_={id:(0,s.OB)("PopUpForm.Providers.secret.label"),defaultMessage:"Client Secret"},Y={email:{form:[[{intlLabel:W,name:"enabled",type:"bool",description:A,size:6}]],schema:r.Ry().shape({enabled:r.Xg().required(l.translatedErrors.required)})},providers:{form:[[{intlLabel:W,name:"enabled",type:"bool",description:A,size:6,validations:{required:!0}}],[{intlLabel:z,name:"key",type:"text",placeholder:Q,size:12,validations:{required:!0}}],[{intlLabel:_,name:"secret",type:"text",placeholder:Q,size:12,validations:{required:!0}}],[{intlLabel:u,placeholder:p,name:"callback",type:"text",size:12,validations:{required:!0}}],[{intlLabel:k,name:"noName",type:"text",validations:{},size:12,disabled:!0}]],schema:r.Ry().shape({enabled:r.Xg().required(l.translatedErrors.required),key:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()}),secret:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()}),callback:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()})})},providersWithSubdomain:{form:[[{intlLabel:W,name:"enabled",type:"bool",description:A,size:6,validations:{required:!0}}],[{intlLabel:z,name:"key",type:"text",placeholder:Q,size:12,validations:{required:!0}}],[{intlLabel:_,name:"secret",type:"text",placeholder:Q,size:12,validations:{required:!0}}],[{intlLabel:{id:(0,s.OB)("PopUpForm.Providers.subdomain.label"),defaultMessage:"Host URI (Subdomain)"},name:"subdomain",type:"text",placeholder:{id:(0,s.OB)("PopUpForm.Providers.subdomain.placeholder"),defaultMessage:"my.subdomain.com"},size:12,validations:{required:!0}}],[{intlLabel:u,placeholder:p,name:"callback",type:"text",size:12,validations:{required:!0}}],[{intlLabel:k,name:"noName",type:"text",validations:{},size:12,disabled:!0}]],schema:r.Ry().shape({enabled:r.Xg().required(l.translatedErrors.required),key:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()}),secret:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()}),subdomain:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()}),callback:r.Z_().when("enabled",{is:!0,then:r.Z_().required(l.translatedErrors.required),otherwise:r.Z_()})})}};var Re=(a,n,o)=>new Promise((Z,B)=>{var N=E=>{try{w(o.next(E))}catch(g){B(g)}},j=E=>{try{w(o.throw(E))}catch(g){B(g)}},w=E=>E.done?Z(E.value):Promise.resolve(E.value).then(N,j);w((o=o.apply(a,n)).next())});const Te=a=>Re(void 0,null,function*(){try{const{data:n}=yield s.be.get((0,s.Gc)("providers"));return n}catch(n){throw a({type:"warning",message:{id:"notification.error"}}),new Error("error")}}),Be=a=>s.be.put((0,s.Gc)("providers"),a);var Le=t(92891);const Ce=a=>(0,Le.sortBy)(Object.keys(a).reduce((n,o)=>{const{icon:Z,enabled:B,subdomain:N}=a[o],j=Z==="envelope"?["fas","envelope"]:["fab",Z];return N!==void 0?n.push({name:o,icon:j,enabled:B,subdomain:N}):n.push({name:o,icon:j,enabled:B}),n},[]),"name");var ue=t(88369),pe=t(41415),xe=t(27677),ve=t(11299),Ae=t(15335),De=t(5803),Ie=t(85025),Ue=t(55225),je=t(31600),Se=t(11406),Ze=t(60216),i=t.n(Ze),we=t(83281),Fe=t(9139),We=t(10369),Ne=Object.defineProperty,me=Object.getOwnPropertySymbols,Ke=Object.prototype.hasOwnProperty,ze=Object.prototype.propertyIsEnumerable,fe=(a,n,o)=>n in a?Ne(a,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[n]=o,ae=(a,n)=>{for(var o in n||(n={}))Ke.call(n,o)&&fe(a,o,n[o]);if(me)for(var o of me(n))ze.call(n,o)&&fe(a,o,n[o]);return a};const ne=({description:a,disabled:n,intlLabel:o,error:Z,name:B,onChange:N,placeholder:j,providerToEditName:w,type:E,value:g})=>{const{formatMessage:$}=(0,P.useIntl)(),G=B==="noName"?`${strapi.backendURL}/api/connect/${w}/callback`:g,J=$({id:o.id,defaultMessage:o.defaultMessage},ae({provider:w},o.values)),H=a?$({id:a.id,defaultMessage:a.defaultMessage},ae({provider:w},a.values)):"";if(E==="bool")return e.createElement(Fe.s,{"aria-label":B,checked:g,disabled:n,hint:H,label:J,name:B,offLabel:$({id:"app.components.ToggleCheckbox.off-label",defaultMessage:"Off"}),onLabel:$({id:"app.components.ToggleCheckbox.on-label",defaultMessage:"On"}),onChange:q=>{N({target:{name:B,value:q.target.checked}})}});const se=j?$({id:j.id,defaultMessage:j.defaultMessage},ae({},j.values)):"",ie=Z?$({id:Z,defaultMessage:Z}):"";return e.createElement(We.o,{"aria-label":B,disabled:n,error:ie,label:J,name:B,onChange:N,placeholder:se,type:E,value:G})};ne.defaultProps={description:null,disabled:!1,error:"",placeholder:null,value:""},ne.propTypes={description:i().shape({id:i().string.isRequired,defaultMessage:i().string.isRequired,values:i().object}),disabled:i().bool,error:i().string,intlLabel:i().shape({id:i().string.isRequired,defaultMessage:i().string.isRequired,values:i().object}).isRequired,name:i().string.isRequired,onChange:i().func.isRequired,placeholder:i().shape({id:i().string.isRequired,defaultMessage:i().string.isRequired,values:i().object}),providerToEditName:i().string.isRequired,type:i().string.isRequired,value:i().oneOfType([i().bool,i().string])};const $e=ne;var He=Object.defineProperty,Ve=Object.defineProperties,Ge=Object.getOwnPropertyDescriptors,ye=Object.getOwnPropertySymbols,Xe=Object.prototype.hasOwnProperty,Qe=Object.prototype.propertyIsEnumerable,ge=(a,n,o)=>n in a?He(a,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[n]=o,Ye=(a,n)=>{for(var o in n||(n={}))Xe.call(n,o)&&ge(a,o,n[o]);if(ye)for(var o of ye(n))Qe.call(n,o)&&ge(a,o,n[o]);return a},Je=(a,n)=>Ve(a,Ge(n));const oe=({headerBreadcrumbs:a,initialData:n,isSubmiting:o,layout:Z,isOpen:B,onSubmit:N,onToggle:j,providerToEditName:w})=>{const{formatMessage:E}=(0,P.useIntl)();return B?e.createElement(Ie.P,{onClose:j,labelledBy:"title"},e.createElement(Ue.x,null,e.createElement(ve.O,{label:a.join(", ")},a.map(g=>e.createElement(ve.$,{key:g},g)))),e.createElement(we.Formik,{onSubmit:g=>N(g),initialValues:n,validationSchema:Z.schema,validateOnChange:!1},({errors:g,handleChange:$,values:G})=>e.createElement(l.Form,null,e.createElement(je.f,null,e.createElement(xe.K,{spacing:1},e.createElement(Ae.r,{gap:5},Z.form.map(J=>J.map(H=>e.createElement(De.P,{key:H.name,col:H.size,xs:12},e.createElement($e,Je(Ye({},H),{error:g[H.name],onChange:$,value:G[H.name],providerToEditName:w})))))))),e.createElement(Se.m,{startActions:e.createElement(pe.z,{variant:"tertiary",onClick:j,type:"button"},E({id:"app.components.Button.cancel",defaultMessage:"Cancel"})),endActions:e.createElement(pe.z,{type:"submit",loading:o},E({id:"global.save",defaultMessage:"Save"}))})))):null};oe.defaultProps={initialData:null,providerToEditName:null},oe.propTypes={headerBreadcrumbs:i().arrayOf(i().string).isRequired,initialData:i().object,layout:i().shape({form:i().arrayOf(i().array),schema:i().object}).isRequired,isOpen:i().bool.isRequired,isSubmiting:i().bool.isRequired,onSubmit:i().func.isRequired,onToggle:i().func.isRequired,providerToEditName:i().string};const ke=oe;var qe=Object.defineProperty,_e=Object.defineProperties,et=Object.getOwnPropertyDescriptors,he=Object.getOwnPropertySymbols,tt=Object.prototype.hasOwnProperty,rt=Object.prototype.propertyIsEnumerable,Ee=(a,n,o)=>n in a?qe(a,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):a[n]=o,le=(a,n)=>{for(var o in n||(n={}))tt.call(n,o)&&Ee(a,o,n[o]);if(he)for(var o of he(n))rt.call(n,o)&&Ee(a,o,n[o]);return a},at=(a,n)=>_e(a,et(n)),Pe=(a,n,o)=>new Promise((Z,B)=>{var N=E=>{try{w(o.next(E))}catch(g){B(g)}},j=E=>{try{w(o.throw(E))}catch(g){B(g)}},w=E=>E.done?Z(E.value):Promise.resolve(E.value).then(N,j);w((o=o.apply(a,n)).next())});const be=()=>{const{formatMessage:a}=(0,P.useIntl)();(0,l.useFocusWhenNavigate)();const{notifyStatus:n}=(0,d.G)(),o=(0,M.useQueryClient)(),{trackUsage:Z}=(0,l.useTracking)(),B=(0,e.useRef)(Z),[N,j]=(0,e.useState)(!1),[w,E]=(0,e.useState)(!1),[g,$]=(0,e.useState)(null),G=(0,l.useNotification)(),{lockApp:J,unlockApp:H}=(0,l.useOverlayBlocker)(),se=(0,e.useMemo)(()=>({update:ue.Z.updateProviders}),[]),{isLoading:ie,allowedActions:{canUpdate:q}}=(0,l.useRBAC)(se),{isLoading:ot,data:ee,isFetching:lt}=(0,M.useQuery)("get-providers",()=>Te(G),{onSuccess(){n(a({id:(0,s.OB)("Providers.data.loaded"),defaultMessage:"Providers have been loaded"}))},initialData:{}}),st=ot||lt,it=(0,M.useMutation)(Be,{onSuccess(){return Pe(this,null,function*(){yield o.invalidateQueries("get-providers"),G({type:"info",message:{id:(0,s.OB)("notification.success.submit")}}),B.current("didEditAuthenticationProvider"),E(!1),de(),H()})},onError(){G({type:"warning",message:{id:"notification.error"}}),H(),E(!1)},refetchActive:!1}),te=(0,e.useMemo)(()=>Ce(ee),[ee]),dt=te.length,Oe=(0,e.useMemo)(()=>{if(!g)return!1;const S=te.find(ce=>ce.name===g);return h()(S,"subdomain")},[te,g]),ct=a({id:(0,s.OB)("HeaderNav.link.providers"),defaultMessage:"Providers"}),ut=(0,e.useMemo)(()=>g==="email"?Y.email:Oe?Y.providersWithSubdomain:Y.providers,[g,Oe]),de=()=>{j(S=>!S)},Me=S=>{q&&($(S.name),de())},pt=S=>Pe(void 0,null,function*(){E(!0),J(),B.current("willEditAuthenticationProvider");const ce=at(le({},ee),{[g]:S});it.mutate({providers:ce})});return e.createElement(C.A,null,e.createElement(l.SettingsPageTitle,{name:ct}),e.createElement(I.o,null,e.createElement(x.T,{title:a({id:(0,s.OB)("HeaderNav.link.providers"),defaultMessage:"Providers"})}),st||ie?e.createElement(l.LoadingIndicatorPage,null):e.createElement(F.D,null,e.createElement(v.i,{colCount:4,rowCount:dt+1},e.createElement(c.h,null,e.createElement(y.Tr,null,e.createElement(b.Th,null,e.createElement(K.Z,{variant:"sigma",textColor:"neutral600"},e.createElement(m.T,null,a({id:(0,s.OB)("Providers.image"),defaultMessage:"Image"})))),e.createElement(b.Th,null,e.createElement(K.Z,{variant:"sigma",textColor:"neutral600"},a({id:"global.name",defaultMessage:"Name"}))),e.createElement(b.Th,null,e.createElement(K.Z,{variant:"sigma",textColor:"neutral600"},a({id:(0,s.OB)("Providers.status"),defaultMessage:"Status"}))),e.createElement(b.Th,null,e.createElement(K.Z,{variant:"sigma"},e.createElement(m.T,null,a({id:"global.settings",defaultMessage:"Settings"})))))),e.createElement(X.p,null,te.map(S=>e.createElement(y.Tr,le({key:S.name},(0,l.onRowClick)({fn:()=>Me(S),condition:q})),e.createElement(b.Td,{width:""},e.createElement(f.G,{icon:S.icon})),e.createElement(b.Td,{width:"45%"},e.createElement(K.Z,{fontWeight:"semiBold",textColor:"neutral800"},S.name)),e.createElement(b.Td,{width:"65%"},e.createElement(K.Z,{textColor:S.enabled?"success600":"danger600","data-testid":`enable-${S.name}`},S.enabled?a({id:"global.enabled",defaultMessage:"Enabled"}):a({id:"global.disabled",defaultMessage:"Disabled"}))),e.createElement(b.Td,le({},l.stopPropagation),q&&e.createElement(O.h,{onClick:()=>Me(S),noBorder:!0,icon:e.createElement(T.Z,null),label:"Edit"})))))))),e.createElement(ke,{initialData:ee[g],isOpen:N,isSubmiting:w,layout:ut,headerBreadcrumbs:[a({id:(0,s.OB)("PopUpForm.header.edit.providers"),defaultMessage:"Edit Provider"}),D()(g)],onToggle:de,onSubmit:pt,providerToEditName:g}))},nt=()=>e.createElement(l.CheckPagePermissions,{permissions:ue.Z.readProviders},e.createElement(be,null))},8917:(V,U,t)=>{t.d(U,{Z:()=>D});var e=t(43653),P=t.n(e),l=t(88425),L=t.n(l),h=(f,C,x)=>new Promise((F,I)=>{var d=y=>{try{c(x.next(y))}catch(b){I(b)}},v=y=>{try{c(x.throw(y))}catch(b){I(b)}},c=y=>y.done?F(y.value):Promise.resolve(y.value).then(d,v);c((x=x.apply(f,C)).next())});const R=P().create({baseURL:"http://localhost:1337"});R.interceptors.request.use(f=>h(void 0,null,function*(){return f.headers={Authorization:`Bearer ${l.auth.getToken()}`,Accept:"application/json","Content-Type":"application/json"},f}),f=>{Promise.reject(f)}),R.interceptors.response.use(f=>f,f=>{var C;throw((C=f.response)==null?void 0:C.status)===401&&(l.auth.clearAppStorage(),window.location.reload()),f});const D=R},59677:(V,U,t)=>{t.d(U,{be:()=>e.Z,YX:()=>L,Gc:()=>D,OB:()=>f.Z});var e=t(8917),P=t(92891);const L=C=>Object.keys(C).reduce((x,F)=>{const I=C[F].controllers,d=Object.keys(I).reduce((v,c)=>((0,P.isEmpty)(I[c])||(v[c]=I[c]),v),{});return(0,P.isEmpty)(d)||(x[F]={controllers:d}),x},{});var h=t(90201);const D=C=>`/${h.Z}/${C}`;var f=t(82069)},11299:(V,U,t)=>{t.d(U,{$:()=>b,O:()=>K});var e=t(32735),P=t(60216),l=t(83292),L=t(77277),h=t(88860),R=t(62345),D=t(36320),f=t(3685),C=Object.defineProperty,x=Object.getOwnPropertySymbols,F=Object.prototype.hasOwnProperty,I=Object.prototype.propertyIsEnumerable,d=(m,O,T)=>O in m?C(m,O,{enumerable:!0,configurable:!0,writable:!0,value:T}):m[O]=T,v=(m,O)=>{for(var T in O||(O={}))F.call(O,T)&&d(m,T,O[T]);if(x)for(var T of x(O))I.call(O,T)&&d(m,T,O[T]);return m},c=(m,O)=>{var T={};for(var M in m)F.call(m,M)&&O.indexOf(M)<0&&(T[M]=m[M]);if(m!=null&&x)for(var M of x(m))O.indexOf(M)<0&&I.call(m,M)&&(T[M]=m[M]);return T};const y=(0,l.default)(D.k)`
  svg {
    height: ${10/16}rem;
    width: ${10/16}rem;
    path {
